...
if direction == "left":
    ...
    swim_or_wait = input(
        "You've arrived to a river. Would you like to swim across or wait for a boat to come? Write 'swim' or 'wait' as your response.\n").lower()
  ...
  {{{  {{{{.CWWV.     .VWWO.{ }}}    `\\\
   ...
   {  {{   CWWWWWWWVWWWWWWWO{   }} 
    ...
    ''')
        ...
        door = input(
            "Great! You have arrived to your final destination. Please choose a door to enter the treasure vault. Is it going to be the red, blue or yellow one? Careful! One wrong move, and you lose the game! \n").lower()
